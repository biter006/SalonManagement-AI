...
public interface IAIService
{
    ...
    Task<AITextResult> RecommendAsync(Customer customer, IReadOnlyCollection<ServiceHistory> history, IReadOnlyCollection<SalonService> services, string need, RecommendationPromptVersion promptVersion, CancellationToken cancellationToken = default)
        => RecommendAsync(customer, history, services, need, cancellationToken);
