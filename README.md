...
19 test hiện có bao phủ: đặt lịch hợp lệ và tính giờ kết thúc, trùng lịch, ngoài ca, quá khứ, kiểm tra ca/thợ, tính hóa đơn và từ chối lịch chưa hoàn thành; AI mock cho phản hồi hợp lệ/rỗng/exception, retry Gemini khi HTTP 503, tư vấn dịch vụ theo dữ liệu salon, và phân quyền dữ liệu AI để Stylist chỉ truy cập khách/lịch hẹn của mình. Test case AI thủ công nằm tại `docs/Test-cases-KT3-AI.md`; test case quản lý nằm tại `docs/Test-cases-KT2.md`.
